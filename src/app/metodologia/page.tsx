    ...
    <div className="container mx-auto px-4 py-12 md:py-16 max-w-4xl">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4">
          {[
            { id: 'V1', name: 'Presión de demanda del país', weight: '25%', desc: 'Mide el porcentaje neto de empresas que planean aumentar contrataciones en cada país (Net Employment Outlook). A mayor NEO, mayor competencia entre empleadores.' },
            { id: 'V2', name: 'Concentración de demanda del perfil', weight: '25%', desc: 'Porcentaje de la demanda total que concentra cada categoría de perfil. A mayor concentración, más empresas compiten por el mismo tipo de candidato. Excepción: perfiles C-Level reciben score alto por escasez de oferta.' },
            { id: 'V3', name: 'Competencia salarial externa', weight: '20%', desc: 'Dispersión del rango salarial como proxy de competencia. A mayor dispersión entre techo y piso salarial, mayor es la guerra por talento. Se añade ajuste por exposición a salarios en USD (remoto internacional).' },
            { id: 'V4', name: 'Exposición al nearshoring', weight: '15%', desc: 'Grado en que el sector del rol está expuesto a contratación internacional. Sectores como tech y desarrollo reciben scores altos. México y Colombia reciben ajuste positivo por ser destinos preferentes.' },
            { id: 'V5', name: 'Fragilidad estructural del mercado', weight: '15%', desc: 'Tasa de informalidad como indicador principal. En países con alta informalidad, el pool de candidatos formales y verificables es proporcionalmente menor.' },
          ].map((v) => (
